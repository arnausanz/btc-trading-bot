...
| Config YAML unificat | ✅ Operatiu | Un YAML per model, best_params in-place, auto-discovery via discover_configs() |
| Walk-forward split | ✅ Operatiu | TRAIN_UNTIL / TEST_FROM al settings |
| Documentació | ✅ Completa | PROJECT (v2.0), MODELS, DB, EXTENDING (v3.0), CONFIG + README.md nou |
